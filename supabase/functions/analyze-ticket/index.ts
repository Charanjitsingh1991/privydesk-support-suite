...
serve(async (req: Request) => {
  ...
  try {
    ...
    // Support multiple AI providers: Groq (fastest/free), OpenRouter (flexible), OpenAI (reliable)
    const AI_PROVIDER = Deno.env.get("AI_PROVIDER") || "groq"; // groq, openrouter, openai
    ...
    switch (AI_PROVIDER) {
      ...
      case "openai":
        ...
        model = "gpt-4o-mini"; // Reliable and affordable
        break;
      default:
...
Be thorough but concise.`;
    ...
    if (AI_PROVIDER === "openrouter") {
      headers["HTTP-Referer"] = "https://privydesk.com";
      headers["X-Title"] = "PRIVYDESK";
    }
