    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-black p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-white/80 mt-2">Secure Support Platform</p>
        </div>
        ...
        <div className="relative z-10 space-y-8">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-white/70 mt-1">No passwords to remember. Sign in securely with magic links or verification codes.</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-xl font-semibold text-white">Email-Based Auth</h3>
              <p className="text-white/70 mt-1">Quick access through your email inbox. No complex passwords required.</p>
            </div>
          </div>
        </div>
